...
//PUT
    ...
    const id = url.pathname.split('/')[2];
    //in my mind: can I refactor the id const? reduce errors/typos, cleaner, function name can make clearer task
    return People.findByIdAndUpdate(id, { name: json.name })
